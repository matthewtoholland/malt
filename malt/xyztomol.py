...
def read_xyz_file(filename, look_for_charge=True, int_atoms=True):
    """
    Reads an xyz file, and returns a list of atomic symbols, the charge on the molecule, and the xyz coordinates of each atom

    args - 
        filename - string, path to file
        look_for_charge - Bool, This isn't used in the function, and I'm not sure what it does, sorry.
        int_atoms - Bool, default = True. If True, returns a list of atoms by atomic number, if false, by symbol
    """
...
def mol_from_xyz(filepath):
    """
    Generates a single rdkit mol object from an xyz file
    args:
